...
export async function seedLorian() {
  ...
  const commercialEventDefs = [
    ...
    { id: "ce_lor_009", type: "BALANCE_REQUESTED" as const, entity: "INVOICE" as const, entityId: "inv_lor_009", actor: "SYSTEM" as const, actorId: null, amt: "21087.00", desc: "Financing offer generated for INV-2026-0009", ago: 28 },
    { id: "ce_lor_010", type: "BALANCE_ACCEPTED" as const, entity: "INVOICE" as const, entityId: "inv_lor_009", actor: "USER" as const, actorId: USERS.admin.id, amt: "21087.00", desc: "Financing accepted by operator for INV-2026-0009", ago: 27 },
    { id: "ce_lor_011", type: "BALANCE_FUNDED" as const, entity: "INVOICE" as const, entityId: "inv_lor_009", actor: "PROVIDER" as const, actorId: null, amt: "21087.00", desc: "Funds disbursed to Lorian account", ago: 26 },
    { id: "ce_lor_012", type: "SPREAD_RECORDED" as const, entity: "INVOICE" as const, entityId: "inv_lor_009", actor: "SYSTEM" as const, actorId: null, amt: "52.00", desc: "Dynasties spread recorded: 75bps markup", ago: 26 },
