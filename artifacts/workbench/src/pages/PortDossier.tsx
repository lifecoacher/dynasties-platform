                ...
                <div className="bg-white rounded-xl border border-slate-200 p-5">
                  ...
                  <div className="space-y-2">
                    {(data.signals?.weather || []).map((w: any, i: number) => (
                      <div key={i} className="p-2 rounded-lg bg-primary/5 border border-primary/15 text-sm">
                        <div className="font-medium text-primary">{w.eventType}</div>
                        <div className="text-xs text-primary">Severity: {w.severity}</div>
                      </div>
                    ))}
                  ...
                  <div className="space-y-2">
                    {(data.signals?.disruptions || []).map((d: any, i: number) => (
                      <div key={i} className="p-2 rounded-lg bg-[#D4A24C]/5 border border-[#D4A24C]/15 text-sm">
                        ...
                        <div className="text-xs text-[#D4A24C]">Severity: {d.severity}</div>
                      </div>
                    ))}
